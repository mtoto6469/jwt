        ...
        <div class="content-center">
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="text-center mb-5"><?=Yii::t('app','HeaderPageLogin')?></h1>
                            ...
                            <div class="text-center my-2">
                                <?= Html::submitButton(Yii::t('app', 'ButtonLogin'), ['class' => 'btn btn-primary btn-block', 'name' => 'login-button']) ?>
                            </div>

                            <div class="text-center my-2">
                                <a href="<?=Yii::$app->urlManager->createAbsoluteUrl('site/signup')?>" class="btn btn-outline-secondary btn-block"><?=Yii::t('app', 'ButtonRedirectSignup')?></a>
                            </div>
